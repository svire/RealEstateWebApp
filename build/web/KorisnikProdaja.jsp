          ...
          %>
                        ...
                        <div class="property-info-list">
                            ...
                            if(omiljeni.equals("ne")){   %>
                             <a style="font-size:30px;text-decoration: none;float:right;" href="DodajUFavorite?nekid=<%=nek.getNekretninaId()%>&tip=SALE"> <span style="color:#edcee2;">&#10084;</span></a>
                             <%   } %>
                             <% if(omiljeni.equals("da")){ %>
                             <a style="font-size:30px;text-decoration: none;float:right;" href="DodajUFavorite?nekid=<%=nek.getNekretninaId()%>&tip=SALE"> <span style="color:red;">&#10084;</span>     </a>
                             <% } %>   
                            </div>
                        </div>
                    </div>
