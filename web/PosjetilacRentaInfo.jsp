    ...
    <center> <div style="background-color:#ceeced; min-height: 1000px;oveflow:hidden;width: 1200px;margin: 50px;" class="container pt-lg-3 pb-md-5" >
            ...
            <div style="height: 180px;">
              ...
              <div style="height:20%;width:25%;background-color:#093145;float:right;">
                     <%
                     Konekcija kon22=new Konekcija();
                     ResultSet rss; 
                     String kveris="select broj_posjeta from mostviewed where nekretnina_id='"+nekid+"'";
                     rss=kon22.query(kveris);
                     while(rss.next()){
                       %>
                       <h3><b>Ovaj oglas je vidjen: <%=rss.getInt(1)%>x</b></h3>
                          <% } %>
