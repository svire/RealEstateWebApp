...
<div id="container" style="overflow: hidden;min-height: 500px;">
    ...
    <div style="background-color:#ceeced;margin:50px; min-height: 700px;"  >
        <center> <h1 style="color:darkcyan;border:1px #008CBA dotted;">Nekretnine</h1> </center>
       ...
       <form action="MenadzerSveNekretnine" method="get">
        ...
        <tr align="center">
          ...
          <td style="background-color: green;"><a style="color:white;text-decoration: none;"href="MenadzerPromjeni?id=<%=pom.getNekretninaId()%>">Promjeni</a></td>
