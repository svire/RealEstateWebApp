...
<div id="container" style="overflow: hidden;min-height: 500px;">
    ...
    <center>
    <div style="background-color:#ceeced;margin:50px; min-height: 800px;" class="container pt-lg-3 pb-md-5" >
        ...
        <h4 style="background-color: darkcyan;width: 20%;"><a style="color:white;" href="KlijentSamoSlike.jsp?id=<%=nekid%>">Dodaj nove slike</a></h4>
        <h4 style="background-color: darkcyan;width: 20%;"><a style="color:white;" href="KlijentObrisiSliku.jsp?id=<%=nekid%>">Obrisi slike</a></h4>
           
           <form action="PromjeniNekretninu" method="post" id="stan" onsubmit="return validacija()">
           <div style="width:100%;min-height: 400px;margin-top: 40px;">
            ...
            <%
                        ...
                        int brslika=0;
                        %>                
         <form action="PromjeniProfilnu" method="get">  
         ...
         <div  style="background-color: darkcyan; border-radius: 15px; width:100%;height: 120px;margin-top:  40px;">
                    ...
                    <div style=" border-radius: 15px; float:left;width:100px;height:100px; background-color: #EBF4cc; margin: 5px;padding:5px; border:2px solid; display:inline-block;" >
                        <div style="height:80%; width:80%;"><img src="Slike/<%=rs.getString(3)%>" height="80%" width="80%">
                            
                        </div>  
                        <% if(rs.getString(6).equals("profile")){ %>
                         <input type="checkbox" checked name="profile" value="<%=rs.getInt(1)%>">
                      <% }  else{%>
                      <input type="checkbox"  name="profile" value="<%=rs.getInt(1)%>">
                      <% } %>
                    </div> 
                        <% }  if(brslika==0){ %>                                                           
