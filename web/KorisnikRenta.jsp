...
<div id="container">
    ...
    <form action="PretraziNekretnineR" method="get">
    <div id="pretraga">
...
<center>
    <section class="portfolio-flyer py-5">
        ...
        <div style="background-color:#ceeced;" class="container pt-lg-3 pb-md-5" >
             <center> <h1 style="color:darkcyan;border: 1px #007bff dotted;">Rentanje nekretnina</h1> </center>
   ...
   <div class="row news-grids pb-lg-5 mt-3" style="">
        <% ArrayList<Rentanje> lista=(ArrayList<Rentanje>)request.getAttribute("renta"); 
                         int brojredova=0;
                         
                        
                         if(lista!=null)
                         {
                         for(Rentanje nek:lista){     
                         brojredova++;
                         %>
                        ...
                        <div class="property-info-list">
                            <div class="detail">
                                ...
                                <ul class="facilities-list clearfix">
                                    ...
                                    <li>
                                        <span class="fa fa-shower"></span> Grijanje: <%=nek.getGrijanje()%>
                                    </li>
                                    <li>
                                        <span class="fa fa-building-o"></span>  <%=nek.getVelicina()%> m2
                                    </li>
                                    <li>
                                        <span class="fa fa-building-o"></span> Struja: <%=nek.getStruja()%>
                                    </li>
                                </ul>
                            </div>
                            ...
                            if(omiljeni.equals("ne")){   %>
                             <a style="font-size:30px;text-decoration: none;float:right;" href="DodajUFavorite?nekid=<%=nek.getNekretninaId()%>&tip=RENT"> <span style="color:#edcee2;">&#10084;</span></a>
                             <%   } %>
                             <% if(omiljeni.equals("da")){ %>
                             <a style="font-size:30px;text-decoration: none;float:right;" href="DodajUFavorite?nekid=<%=nek.getNekretninaId()%>&tip=RENT"> <span style="color:red;">&#10084;</span>     </a>
                             <% } %>   
