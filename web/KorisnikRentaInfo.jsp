    ...
    <center> <div style="background-color:#ceeced; min-height: 1000px;oveflow:hidden;width: 1200px;margin: 50px;" class="container pt-lg-3 pb-md-5" >
            ...
            <div style="height: 180px;">
                <div style="height:100%;width:30%;background-color: darkorange;float:left;padding:20px;border-radius: 25px;">
                 ...
                 <h2 style="float:left;"><b>Apartman:<%=nekid%>|<span style="color:red;font-size: 22px;"><%=cijena%>€</span></b></h2> <br><br>
                ...
                <div style="height:60%;width: 25%;background-color: khaki;float:right; padding: 10px;">
                    <b>Postavi pitanje:</b>
                     <a href="#pisi"><img src="Slike/por.png" style="height:80px;width:100px;"></a>
                </div>
           ...
           <% } %>
            ...
            <div id="red_dodatno">       
                ...
                <div style="height: 40%;width:100%;float:left;background-color:khaki;font-size:19px;">
                    ...
                    <form method="post" action="PostaviPitanje">
                        <input type="hidden" value="pitanje" name="tema">
                        <input type="hidden" value="<%=grad%>" name="grad">
                        <input type="hidden" value="<%=ulica%>" name="ulica">
                        <input type="hidden" value="<%=tip%>" name="tip">
                    <div style="height: 32%;width: 100%;background-color: darkred;margin-bottom: 0px;">
                    <div style="height: 100%;width:100%;float:left;">
                        <div style="height: 30%;width:100%;background-color: green;"><h3>Pitanje</h3></div>
                        <div style="height:45%;width:100%;">
                             <textarea id="pisi" name="sadrzaj" style="box-sizing:border-box;height:100%;width:100%;"></textarea>
