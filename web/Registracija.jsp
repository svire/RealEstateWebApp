...
<div id="container" style="min-height: 500px;">
   ...
   <center>
    ...
    <div style="background-color:#ceeced; min-height: 400px;" class="container pt-lg-3 pb-md-5" >
         <center> <h1 style="color:darkcyan;border: 1px #007bff dotted;">Registracija</h1> </center>
        <center> <div id="greska1"></div></center>
         <%  String poruka=(String)request.getAttribute("poruka");
        if(poruka!=null){
    %>
        <center> <h2 style="color:darkcyan;"><%=poruka%></h2></center>
    <% } %>
        <center>
        <form action="Registracija" method="post" class="prijava" style="margin:50px;"  onsubmit="return validacija()" >             
                <table id="table" cellpadding="3">
                    ...
                    <tr>
                        <td colspan="2">
                    <center>    <input type="submit" value="Registruj se">     <input type="reset" value="Reset">      </center>        
                        </td>
                    </tr>                   
                  </table>       
            </form>   
