 ...
 * @author Djole
 */
public class DodajUFavorite extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(tip.equals("SALE")){
         ...
         redirect="PretraziNekretnineP";
        
        }
        if(tip.equals("RENT")){
            
            redirect="PretraziNekretnineR";
        }
        if(tip.equals("DAILY")){
        
         redirect="PretraziNekretnineS";
        
        }
        if(tip.equals("FAV"))
        {
            redirect="KorisnikMojiFavoriti";
        }
