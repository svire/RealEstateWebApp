 ...
 * @author Djole
 */
public class MenadzerPromjeni extends HttpServlet {
        ...
        if(tip.equals("SALE")){
            ...
            try{
                ...
                nek.setStatus(status);
                  ...
                  request.getRequestDispatcher("MenadzerPromjeniProdaja.jsp").forward(request, response);
        ...
        if(tip.equals("DAILY")){
            ...
            try{      
                ...
                nek.setStatus(status);
                 ...
                 request.getRequestDispatcher("MenadzerPromjeniStan.jsp").forward(request, response);
        ...
        if(tip.equals("RENT"))
        {
            ...
            try{
                ...
                nek3.setUseljiv(useljiv);
                 ...
                 request.getRequestDispatcher("MenadzerPromjeniRenta.jsp").forward(request, response);
